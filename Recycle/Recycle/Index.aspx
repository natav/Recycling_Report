...
<form id="Form1" runat="server">
    ...
    <div>
        <table style="text-align: center; width: 1157px;">
             <tr style="align-content:center; width: 100%;"><td style="text-align: center">.::  banner goes here  ::.</td></tr>
        </table>
     </div>
            ...
            <td style="width:35%; vertical-align: top;">
                <div style="vertical-align: top;">
                    <table>
                        ...
                        <tr>
                            <td class="align-right"><input type="submit" value="Submit" class="btn" runat="server" id="btnSubmit" /></td>
